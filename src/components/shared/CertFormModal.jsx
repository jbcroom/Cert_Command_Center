...
export default function CertFormModal({ open, onClose, cert, onSaved }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm md:flex md:items-center md:justify-center">
      <div className="absolute inset-x-0 bottom-0 rounded-t-2xl md:static md:rounded-xl bg-bg-surface border border-bg-elevated shadow-2xl w-full md:max-w-2xl md:mx-4 max-h-[90vh] flex flex-col">
        <div className="md:hidden w-10 h-1 bg-bg-elevated rounded-full mx-auto mt-3 mb-1 flex-shrink-0" />
        ...
        <div className="flex flex-col-reverse sm:flex-row gap-3 px-6 py-4 border-t border-bg-elevated flex-shrink-0">
          ...
          <button
            ...
            className="px-4 py-2 min-h-[44px] w-full sm:w-auto rounded-lg text-sm font-medium bg-accent-blue text-white hover:bg-accent-blue/80 disabled:opacity-40 disabled:cursor-not-allowed transition-colors">
